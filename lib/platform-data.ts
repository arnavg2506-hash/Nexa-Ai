...
export const platformPlans = [
  {
    name: "Explorer",
    price: "INR 9K",
    description: "For buyers exploring one city or district.",
    features: ["AI city search", "District reports", "Basic map layers", "10 saved locations"],
  },
  {
    name: "Investor",
    price: "INR 39K",
    description: "For serious investors comparing land and homes.",
    highlighted: true,
    features: ["Land and homes dashboards", "Growth alerts", "Comparison engine", "AI copilot"],
  },
  {
    name: "Professional",
    price: "INR 1.25L",
    description: "For advisors, brokers, and family-office analysts.",
    features: ["Builder intelligence", "Portfolio tracking", "Private watchlists", "Exportable reports"],
  },
  {
    name: "Enterprise",
    price: "Custom",
    description: "For developers, funds, and land acquisition teams.",
    features: ["PostgreSQL data room", "Custom AI workflows", "Mapbox layer ingestion", "Dedicated API access"],
  },
];
